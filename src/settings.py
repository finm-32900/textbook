...
d["GITHUB_PAGES_REPO_DIR"] = if_relative_make_abs(_config('GITHUB_PAGES_REPO_DIR', default=d["BASE_DIR"] / '../finm-32900.github.io/', cast=Path))
# fmt: on
...
def create_dirs():
    ...
    (d["BASE_DIR"] / "_docs/notebooks").mkdir(parents=True, exist_ok=True)
    (d["BASE_DIR"] / "_docs/notebooks/assets").mkdir(parents=True, exist_ok=True)
